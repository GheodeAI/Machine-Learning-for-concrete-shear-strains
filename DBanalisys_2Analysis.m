...
writematrix(Yprd_rf,'RF_pred2.xls');
...
writematrix(Yprd_lr,'LREG_pred2.xls');
writematrix(Yprd_ls,'LASSO_pred2.xls');
...
writematrix(Yprd_g,'SVR_g_pred2.xls');
writematrix(Yprd_l,'SVR_l_pred2.xls');
writematrix(Yprd_p,'SVR_p_pred2.xls');
...
writematrix(Yprd,'MLP_pred2.xls');
